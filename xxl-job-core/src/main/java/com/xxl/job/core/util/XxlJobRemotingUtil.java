...
public class XxlJobRemotingUtil {
    ...
    public static ReturnT postBody(String url, String accessToken, int timeout, Object requestObj, Class returnTargClassOfT) {
        ...
        try {
            ...
            // 修改超时时间
            connection.setReadTimeout((timeout > 1000 ? timeout : 1000) * 1000);
            ...
            try {
                ...
                // todo 2020-12-10 cc 连接超时，run 方法 更新数据库状态为执行中。。，其余失败
                if (url.contains("run")) {
                    return new ReturnT<String>(ReturnT.RUNNING_CODE, "任务正在执行中。。");
                }
                return new ReturnT<String>(ReturnT.FAIL_CODE, "任务连接超时，结果丢失，任务失败");
            }
